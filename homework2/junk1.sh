...
#PROGRAMMERS:    Cameron Weston (Cameron93), Zach Olson (Olson1216)
...
#Cameron Weston 50%-
#-created the appropriate output when junk -l [fileName1 fileName2 ...] is entered
#-created the appropriate output when junk -p [fileName1 fileName2 ...] is entered
#Zachary Olson 50%-
#-created the appropriate output for Case I
#-created the appropriate output for Case II
#-created the appropriate output for Case III
#FILES:             junk
